...
struct _VehiculeClass
{
    ...
    // Les membres de classes (méthodes et variables) sont partagés par l'ensemble des objets de la classes.
    // En C++, ils sont déclarés à l'aide du mot-clé static.
    // Pour obtenir le même résultat, nous avons juste à ajouter un membre dans la structure qui définie notre classe :
    /*< private >*/
    gint static_integer;
};
